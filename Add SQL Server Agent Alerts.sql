...
/****** Object:  Operator [SQLDBAGroup]    Script Date: 7/12/2017 8:28:23 AM ******/
EXEC msdb.dbo.sp_add_operator @name=N'SQLDBAGroup', 
		@enabled=1, 
		...
		@pager_days=0, 
		@email_address=N'tony.green@spacelabs.com', 
...
/*
SELECT * FROM [dbo].[sysalerts] AS [s]
GO

EXEC [dbo].[sp_delete_alert] @name = N'PER730XD Alert - Error 823: The operating system returned an error'
EXEC [dbo].[sp_delete_alert] @name = N'PER730XD Alert - Error 824: Logical consistency-based I/O error'
EXEC [dbo].[sp_delete_alert] @name = N'PER730XD Alert - Error 825: Read-Retry Required'
EXEC [dbo].[sp_delete_alert] @name = N'PER730XD Alert - Error 832: Constant page has changed'
EXEC [dbo].[sp_delete_alert] @name = N'PER730XD Alert - Sev 19 Error: Fatal Error in Resource'
EXEC [dbo].[sp_delete_alert] @name = N'PER730XD Alert - Sev 20 Error: Fatal Error in Current Process'
EXEC [dbo].[sp_delete_alert] @name = N'PER730XD Alert - Sev 21 Error: Fatal Error in Database Process'
EXEC [dbo].[sp_delete_alert] @name = N'PER730XD Alert - Sev 22 Error: Fatal Error: Table Integrity Suspect'
EXEC [dbo].[sp_delete_alert] @name = N'PER730XD Alert - Sev 23 Error: Fatal Error Database Integrity Suspect'
EXEC [dbo].[sp_delete_alert] @name = N'PER730XD Alert - Sev 24 Error: Fatal Hardware Error'
EXEC [dbo].[sp_delete_alert] @name = N'PER730XD Alert - Sev 25 Error: Fatal Error'
*/

/*
RAISERROR (N'TEST ALERTING 10', 10, 1) WITH NOWAIT;

RAISERROR (N'TEST ALERTING 16', 16, 1) WITH NOWAIT;

RAISERROR (N'TEST ALERTING 20', 20, 1) WITH LOG;
*/
